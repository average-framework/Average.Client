...
{
    internal class TextAreaItem : IMenuItem
    {
        ...
        public TextAreaItem(string text, object value, string placeholder, string pattern, int minLength, int maxLength, Action<object> action, bool visible = true)
        {
            Name = RandomString();
            Text = text;
            Value = value;
